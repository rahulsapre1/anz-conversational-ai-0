...
-- Description: Initial database schema for ContactIQ
-- Created: 2024-01-09
-- 
-- This migration creates the core tables for the ContactIQ application:
-- - interactions: Primary logging table for all user interactions
-- - escalations: Tracks escalation events for analytics
-- - knowledge_documents: Registry of knowledge base documents
