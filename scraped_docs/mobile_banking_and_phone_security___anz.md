Title: Mobile banking and phone security  | ANZ
Source URL: https://www.anz.com.au/security/protect-devices/secure-smart-device-apps/
...
- Set up a virtual private network (VPN) for your phone. A VPN creates a secure and encrypted network over the internet. This private network hides and scrambles your internet activity and can make it difficult for cybercriminals to intercept the data on your phone. For example, using a VPN when logging into your online banking can make it harder for hackers to read the information you’re entering. To use a VPN on your phone, you must go to your device’s app store (such as the Google Play Store), download your chosen VPN app, which may require a paid subscription, and log in. Once the app is set up, you’ll need to go into your settings and find the network or VPN configuration option, add a VPN and enter your details from your app.
- Update your phone’s operating systems regularly. Turn on automatic updates in your phone’s system settings to ensure your phone will stay protected against any known weaknesses in your phone.
- Turn on multi-factor authentication (MFA) for all your accounts . This means you’ll need more than just your password to access your account. For example, you might use a password and a unique code on an authenticator app to log into your social media account.
- “ Back up your phone ,” Erica advises. “This might help protect you from losing any precious information if your device is lost, stolen or infected by malware.”
- Use your phone’s remote tracking features , such as Apple’s ‘Find My’ feature or Google’s Find Your Phone, to help you find your phone or delete its contents if it’s lost or stolen.
- Encrypt your phone’s data . This stores your data in a form that can be read and accessed only when you unlock your phone. Apple and Samsung devices are encrypted when you set up your passcode, pattern, or face ID, but you can double-check in your phone’s system settings.
...
anzcomau:content-hubs/security/keep-your-devices-secure Mobile banking and phone security ANZ Security specialist 2024-09-18 /content/dam/anzcomau/images/security-hub/keep-your-devices-secure/phone-security-banner-1200x800.jpg Only display AhContent Only display AhContent Only display AhContent Only display AhContent Only display AhContent Use placeholder part from /apps/core/wcm/components/commons/v1/templates.html ## Learn how to protect your phone and yourself
...
- Keep your devices secure Malware: What it is and how to protect yourself ANZ Security specialist Learn how to protect your devices from malware. Discover common malware types, warning signs of infection, and how to secure your personal and business data online. 2024-09-17 04:30
...
---
Original URL: https://www.anz.com.au/security/protect-devices/secure-smart-device-apps/
Scraped: 2026-01-09
